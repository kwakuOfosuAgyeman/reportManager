                                            ...
                                            @endforeach   --}}
                                             ...
                                             @if ($customColumns)
                                                  ...
                                                  <tr class="text-center">
                                                       ...
                                                       <td>{{$col['manual_editing'] === 1 ? "No" : "Yes"}}</td>
                                                       <td>{{$col['mass_update'] === 1 ? "No" : "Yes"}}</td>
                                                       <td><small><a href=""> Edit <i class="fe fe-edit" data-toggle="tooltip" title="fe fe-edit"></i></a></small></td>
